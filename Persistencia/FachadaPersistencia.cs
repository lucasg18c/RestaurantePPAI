...
namespace RestaurantePPAI.Persistencia
{
    ...
    {
        // ESTA CLASE ES UNA SIMULACIÓN DE UNA FACHADA DE PERSISTENCIA
        ...
        private FachadaPersistencia()
        {
            ...
            detalles.Add(new DetalleDePedido(3, new DateTime(2020, 10, 31, 22, 20,0), new ProductoDeCarta(new Producto("Pizza", 400)), enPreparacion));
            ...
            detalles.Add(new DetalleDePedido(3, new DateTime(2020, 10, 31, 22, 10,0), new ProductoDeCarta(new Producto("Zapallo", 900)), notificado));
            detalles.Add(new DetalleDePedido(3, new DateTime(2020, 10, 31, 22, 13,0), new ProductoDeCarta(new Producto("Fideos", 120)), enPreparacion));
